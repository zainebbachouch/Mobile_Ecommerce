...
public class MainActivity extends AppCompatActivity implements ShoeItemAdapter.ShoeClickedListeners {
    ...
    private ImageView cartImageView,delivery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("Carrrrrrrrrrrrrrrt", "Card clicked: " + R.id.cartIv);
    ...
    private void initializeVariables() {
        ...
        delivery = findViewById(R.id.delevryicon);
        delivery.setOnClickListener(View ->{
            Intent intent = new Intent(MainActivity.this, List_Cmd.class);
    ...
    public void onCardClicked(ShoeItem shoe) {
        Log.d("ClickEventtttt", "Card clicked: " + shoe.getShoeName());
